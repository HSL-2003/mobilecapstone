...
class _CommonReportIncidentScreenState extends State<CommonReportIncidentScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Báo cáo sự cố', style: TextStyle(fontWeight: FontWeight.w600, letterSpacing: -0.5)),
        backgroundColor: Colors.white,
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              decoration: const BoxDecoration(color: Color(0xFFF26F21)),
              child: const Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                   Text('Ghi nhận Sự cố', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.white, letterSpacing: -0.5)),
                   SizedBox(height: 8),
                   Text('Vui lòng chọn ca học và lớp học hôm nay của bạn trước khi điền thông tin sự cố.', style: TextStyle(color: Colors.white, fontSize: 14)),
                ],
              ),
            ),
            Padding(
                  ...
                  children: [
                      ...
                      Container(
                        ...
                        child: const Row(
                          children: [
                            ...
                            SizedBox(width: 8),
                            Expanded(child: Text('Bạn không có slot nào trong ngày hôm nay nên không thể tạo báo cáo sự cố .', style: TextStyle(color: Colors.red))),
                          ],
                        ),
                      )
                    else
                    ...
                    if (_isLoadingClasses)
                      ...
                      _buildDropdown(
                        ...
                        items: _todayClasses.map((c) {
                          // ID có thể là id, classId, hoặc tạm dùng className nếu ko có ID
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: (_selectedSlotName == null || _selectedClassId == null) ? null : () async {
                          if (_formKey.currentState!.validate()) {
                            ...
                            try {
                              final response = await _reportService.createReport(
                                ...
                                className: _selectedClassId!, // Dropdown map ID hoặc Name vào val này
                              );
                        ...
                        child: const Text('GỬI BÁO CÁO', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: Colors.white, letterSpacing: 1.0)),
                      ),
                    ),
                  ],
                ),
